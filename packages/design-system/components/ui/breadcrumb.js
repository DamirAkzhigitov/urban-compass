...
const BreadcrumbSeparator = ({ children, className, ...props }) => ((0, jsx_runtime_1.jsx)("li", { role: "presentation", "aria-hidden": "true", className: (0, utils_1.cn)("[&>svg]:w-3.5 [&>svg]:h-3.5", className), ...props, children: children ?? (0, jsx_runtime_1.jsx)(react_icons_1.ChevronRightIcon, {}) }));
