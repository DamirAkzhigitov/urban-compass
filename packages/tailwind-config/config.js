...
const typography_config_1 = __importDefault(require("./typography.config"));
exports.config = {
    darkMode: ['class'],
    content: [
    ...
    theme: {
        ...
        extend: {
            ...
            fontFamily: {
                sans: ['var(--font-geist-sans)', ...defaultTheme_1.default.fontFamily.sans],
                mono: ['var(--font-geist-mono)', ...defaultTheme_1.default.fontFamily.mono],
            },
            keyframes: {
                'accordion-down': {
                    from: { height: '0' },
            ...
            typography: typography_config_1.default,
        },
    },
    plugins: [tailwindcss_animate_1.default, typography_1.default],
};
