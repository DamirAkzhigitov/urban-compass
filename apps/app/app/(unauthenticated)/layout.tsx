    ...
    <div className="relative hidden h-full flex-col bg-muted p-10 text-black dark:text-white lg:flex dark:border-r">
      ...
      <div className="relative z-20 mt-auto">
        <blockquote className="space-y-2">
          <p className="text-lg">
            &ldquo;JavaScript is the river that flows between
            worlds—ever-changing, yet always finding its way. To understand it
            is not to control it, but to flow with it.&rdquo;
          </p>
          <footer className="text-sm">Dee P. Sik</footer>
        </blockquote>
      </div>
    </div>
